...
import com.yanzhenjie.andserver.sample.util.UnzipFromAssets;
...
//        }
        ...
        try {
            UnzipFromAssets.unZip(getApplicationContext(), "web.zip", "/storage/emulated/0/web2", true);
        } catch (IOException e) {
            Log.i("temp", "解压失败");
            e.printStackTrace();
        }
...
//                .website(new AssetsWebsite(getAssets(), "web"))
                .website(new StorageWebsite("/storage/emulated/0/web2/web"))
